...
if(NOT DEFINED ENV{KOKKOS_PATH})
  ...
  # ExternalProject_Get_Property(kokkos install_dir) set(CMAKE_MODULE_PATH
  # "${PROJECT_BINARY_DIR}/external/src/kokkos-build/install"  ${CMAKE_MODULE_PATH})
  ...
  if(NOT EXISTS $ENV{KOKKOS_PATH}/kokkos.cmake)
    message(
      FATAL_ERROR
        "file kokkos.cmake does not exists in \"$ENV{KOKKOS_PATH}\" ! Check your kokkos installation"
    )
  endif()
