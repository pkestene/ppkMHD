...
if(NOT DEFINED KOKKOS_CONFIGURE_LINE)
  set(KOKKOS_CONFIGURE_LINE
      "--with-cuda --arch=Kepler30 --with-cuda-options=enable_lambda --with-openmp --with-hwloc=/usr"
  )
endif()
...
# build the main project set (EXTRA_CMAKE_ARGS) ist (APPEND EXTRA_CMAKE_ARGS
# -DKOKKOS_PATH=${CMAKE_CURRENT_BINARY_DIR}/Dependencies/Source/ep_boost -DBoost_NO_SYSTEM_PATHS=ON)
