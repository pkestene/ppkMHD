...
inline STENCIL_ID get_stencilId_from_solver_name(const std::string& name,
...
// =======================================================
// =======================================================
inline std::array<std::string,STENCIL_TOTAL_NUMBER> make_stencil_names()
{
...
// =======================================================
// =======================================================
inline std::array<std::string,STENCIL_TOTAL_NUMBER> make_valid_solver_names()
{
