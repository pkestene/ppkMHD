 ...
 */
constexpr real_t QUADRATURE_LOCATION_2D_N1_X_M[1][2] = { { -0.5, 0.0 } };
 ...
 */
constexpr real_t QUADRATURE_LOCATION_2D_N1_X_P[1][2] = { { 0.5, 0.0 } };
 ...
 */
constexpr real_t QUADRATURE_LOCATION_2D_N1_Y_M[1][2] = { { 0.0, -0.5 } };
 ...
 */
constexpr real_t QUADRATURE_LOCATION_2D_N1_Y_P[1][2] = { { 0.0, 0.5 } };
 ...
 * Left interface along X axis.
 */
constexpr real_t QUADRATURE_LOCATION_3D_N1_X_M[1][3] = { { -0.5, 0.0, 0.0 } };
 ...
 * Right interface along X axis.
 */
constexpr real_t QUADRATURE_LOCATION_3D_N1_X_P[1][3] = { { 0.5, 0.0, 0.0 } };
 ...
 * Left interface along Y axis.
 */
constexpr real_t QUADRATURE_LOCATION_3D_N1_Y_M[1][3] = { { 0.0, -0.5, 0.0 } };
 ...
 * Right interface along Y axis.
 */
constexpr real_t QUADRATURE_LOCATION_3D_N1_Y_P[1][3] = { { 0.0, 0.5, 0.0 } };
 ...
 */
constexpr real_t QUADRATURE_LOCATION_3D_N1_Z_M[1][3] = { { 0.0, 0.0, -0.5 } };
 ...
 */
constexpr real_t QUADRATURE_LOCATION_3D_N1_Z_P[1][3] = { { 0.0, 0.0, 0.5 } };
