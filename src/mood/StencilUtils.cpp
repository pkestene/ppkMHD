...
std::array<std::string, STENCIL_TOTAL_NUMBER> StencilUtils::solver_names =
  make_valid_solver_names();

// =======================================================
// =======================================================
std::string
StencilUtils::get_stencil_name(STENCIL_ID id)
{
...
// =======================================================
void
StencilUtils::print_stencil(const Stencil & stencil)
{
