...
public:
  ...
  apply(HydroParams params, RisingBubbleParams rbparams, DataArray3d Udata, VectorField3d gravity)
  {
    ...
    Kokkos::parallel_for("RisingBubbleFunctor3D", Kokkos::RangePolicy<>(0, nbCells), functor);
  }
...
public:
        ...
        VectorField3d      gravity)
  {
    ...
    Kokkos::parallel_for("InitDiskFunctor3D", Kokkos::RangePolicy<>(0, nbCells), functor);
  }
