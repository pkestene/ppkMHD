...
public:
  ...
  static void
  apply(HydroParams params, DataArray3d Udata)
  {
    InitFakeFunctor3D functor(params, Udata);
    Kokkos::parallel_for("InitFakeFunctor3D",
...
public:
  ...
  apply(HydroParams params, ImplodeParams iparams, DataArray3d Udata)
  {
    ...
    Kokkos::parallel_for("InitImplodeFunctor3D",
                         Kokkos::MDRangePolicy<Kokkos::Rank<3>>(
                           { 0, 0, 0 }, { params.isize, params.jsize, params.ksize }),
                         functor);
  }
...
public:
  ...
  apply(HydroParams params, BlastParams bParams, DataArray3d Udata)
  {
    ...
    Kokkos::parallel_for("InitBlastFunctor3D",
                         Kokkos::MDRangePolicy<Kokkos::Rank<3>>(
                           { 0, 0, 0 }, { params.isize, params.jsize, params.ksize }),
                         functor);
  }
...
public:
  ...
  apply(HydroParams params, KHParams khParams, DataArray3d Udata)
  {
    ...
    Kokkos::parallel_for("InitKelvinHelmholtzFunctor3D",
                         Kokkos::MDRangePolicy<Kokkos::Rank<3>>(
                           { 0, 0, 0 }, { params.isize, params.jsize, params.ksize }),
                         functor);
  }
...
public:
  ...
  // static method which does it all: create and execute functor
  static void
  apply(HydroParams params, GreshoParams gvParams, DataArray3d Udata)
  {
    InitGreshoVortexFunctor3D functor(params, gvParams, Udata);
    Kokkos::parallel_for("InitGreshoVortexFunctor3D",
                         Kokkos::MDRangePolicy<Kokkos::Rank<3>>(
                           { 0, 0, 0 }, { params.isize, params.jsize, params.ksize }),
                         functor);
  }
 ...
 */
class RisingBubbleFunctor3D : public HydroBaseFunctor3D
{

public:
  RisingBubbleFunctor3D(HydroParams        params,
  ...
  // static method which does it all: create and execute functor
  static void
  apply(HydroParams params, RisingBubbleParams rbparams, DataArray3d Udata, VectorField3d gravity)
  {
    RisingBubbleFunctor3D functor(params, rbparams, Udata, gravity);
    Kokkos::parallel_for("RisingBubbleFunctor3D",
                         Kokkos::MDRangePolicy<Kokkos::Rank<3>>(
                           { 0, 0, 0 }, { params.isize, params.jsize, params.ksize }),
                         functor);
  }
  ...
  operator()(const int & i, const int & j, const int & k) const
  {
    ...
    const real_t gravity_z = rbparams.gz;
    ...
    // P = P0 + rho g z
    Udata(i, j, k, IE) =
      (P0 + Udata(i, j, k, ID) * (gravity_x * x + gravity_y * y + gravity_z * z)) / (gamma0 - 1.0);
...
public:
        ...
        VectorField3d      gravity)
  {
    ...
    Kokkos::parallel_for("InitDiskFunctor3D",
                         Kokkos::MDRangePolicy<Kokkos::Rank<3>>(
                           { 0, 0, 0 }, { params.isize, params.jsize, params.ksize }),
                         functor);
  }
  ...
  operator()(const int & i, const int & j, const int & k) const
  {
...

    {
      ...
      if (r > radius || fabs(z) > 0.5 * radius)
      {
        ...
        if (r > radius + contrast_width || fabs(z) > 0.5 * radius + contrast_width)
        {
        ...
        else
        {
          ...
          const real_t cutdown =
            fmax((r - radius) / contrast_width, (fabs(z) - 0.5 * radius) / contrast_width);
      ...
      Udata(i, j, k, IE) = pressure / (gamma0 - 1.0) + 0.5 * rho * omega2 * (r2 + eps * eps);
    }
