...
public:
  ...
  MHDBaseFunctor3D(HydroParams params)
    : params(params){};
  ...
  KOKKOS_INLINE_FUNCTION
  void
  get_state(DataArray data, int i, int j, int k, MHDState & q) const
  {
  ...
  KOKKOS_INLINE_FUNCTION
  void
  set_state(DataArray data, int i, int j, int k, const MHDState & q) const
  {
  ...
  KOKKOS_INLINE_FUNCTION
  void
  slope_unsplit_hydro_3d_scalar(real_t   q,
                                real_t   qPlusX,
                                real_t   qMinusX,
                                real_t   qPlusY,
                                real_t   qMinusY,
  ...
  KOKKOS_INLINE_FUNCTION
  void
  slope_unsplit_hydro_3d(const MHDState & q,
                         ...
                         MHDState (&dq)[3]) const
  {
    ...
    { // minmod or average
      ...
      slope_unsplit_hydro_3d_scalar(q[ID],
                                    qPlusX[ID],
                                    qMinusX[ID],
                                    qPlusY[ID],
                                    qMinusY[ID],
                                    ...
                                    &(dqY[ID]),
                                    &(dqZ[ID]));
      slope_unsplit_hydro_3d_scalar(q[IP],
                                    qPlusX[IP],
                                    qMinusX[IP],
                                    qPlusY[IP],
                                    qMinusY[IP],
                                    ...
                                    &(dqY[IP]),
                                    &(dqZ[IP]));
      slope_unsplit_hydro_3d_scalar(q[IU],
                                    qPlusX[IU],
                                    qMinusX[IU],
                                    qPlusY[IU],
                                    qMinusY[IU],
                                    ...
                                    &(dqY[IU]),
                                    &(dqZ[IU]));
      slope_unsplit_hydro_3d_scalar(q[IV],
                                    qPlusX[IV],
                                    qMinusX[IV],
                                    qPlusY[IV],
                                    qMinusY[IV],
                                    ...
                                    &(dqY[IV]),
                                    &(dqZ[IV]));
      slope_unsplit_hydro_3d_scalar(q[IW],
                                    qPlusX[IW],
                                    qMinusX[IW],
                                    qPlusY[IW],
                                    qMinusY[IW],
  ...
  KOKKOS_INLINE_FUNCTION
  void
  slope_unsplit_mhd_3d(const real_t (&bfNeighbors)[15], real_t (&dbf)[3][3]) const
  {
  ...
  KOKKOS_INLINE_FUNCTION
  void
  trace_unsplit_mhd_3d_simpler(const MHDState q,
                               MHDState (&dq)[THREE_D],
