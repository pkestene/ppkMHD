...
public:
  ...
  operator()(const int & index) const
  {
    ...
    if (k >= 0 && k < ksize - 1 && j >= 0 && j < jsize - 1 && i >= 0 && i < isize - 1)
    {
...
public:
  ...
  operator()(const int & index) const
  {
    ...
    if (k >= ghostWidth - 2 && k < ksize - ghostWidth + 1 && j >= ghostWidth - 2 &&
        j < jsize - ghostWidth + 1 && i >= ghostWidth - 2 && i < isize - ghostWidth + 1)
    {
