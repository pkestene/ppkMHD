                        ...
                        bool                               singleStep)
{
  ...
  xdmfFile << "    <Grid Name=\"TimeSeries\" GridType=\"Collection\" CollectionType=\"Temporal\">"
           << std::endl;
  ...
  for (int iStep = startStep; iStep <= stopStep; iStep += deltaStep)
  {
    ...
    // topology CoRectMesh
    if (dimType == TWO_D)
      xdmfFile << "      <Topology TopologyType=\"2DCoRectMesh\" NumberOfElements=\"" << nyg << " "
               << nxg << "\"/>" << std::endl;
    else
      xdmfFile << "      <Topology TopologyType=\"3DCoRectMesh\" NumberOfElements=\"" << nzg << " "
               << nyg << " " << nxg << "\"/>" << std::endl;
    ...
    if (dimType == TWO_D)
      ...
      xdmfFile << "           Dimensions=\"" << nzg << " " << nyg << " " << nxg << "\""
               << std::endl;
    ...
    if (dimType == THREE_D and !mhdEnabled)
    {
      ...
      xdmfFile << "           Dimensions=\"" << nzg << " " << nyg << " " << nxg << "\""
               << std::endl;
      xdmfFile << "           Format=\"HDF\">" << std::endl;
      xdmfFile << "           " << hdf5Filename << ":/" << variables_names.at(IW) << ""
               << std::endl;
      xdmfFile << "        </DataStructure>" << std::endl;
      xdmfFile << "      </Attribute>" << std::endl;
    }
    ...
    if (mhdEnabled)
    {
      ...
      if (dimType == TWO_D)
        ...
        xdmfFile << "           Dimensions=\"" << nzg << " " << nyg << " " << nxg << "\""
                 << std::endl;
      xdmfFile << "           Format=\"HDF\">" << std::endl;
      xdmfFile << "           " << hdf5Filename << ":/" << variables_names.at(IA) << ""
               << std::endl;
      xdmfFile << "        </DataStructure>" << std::endl;
      xdmfFile << "      </Attribute>" << std::endl;
      ...
      if (dimType == TWO_D)
        ...
        xdmfFile << "           Dimensions=\"" << nzg << " " << nyg << " " << nxg << "\""
                 << std::endl;
      xdmfFile << "           Format=\"HDF\">" << std::endl;
      xdmfFile << "           " << hdf5Filename << ":/" << variables_names.at(IB) << ""
               << std::endl;
      xdmfFile << "        </DataStructure>" << std::endl;
      xdmfFile << "      </Attribute>" << std::endl;
      ...
      if (dimType == TWO_D)
        ...
        xdmfFile << "           Dimensions=\"" << nzg << " " << nyg << " " << nxg << "\""
                 << std::endl;
      xdmfFile << "           Format=\"HDF\">" << std::endl;
      xdmfFile << "           " << hdf5Filename << ":/" << variables_names.at(IC) << ""
               << std::endl;
      xdmfFile << "        </DataStructure>" << std::endl;
      xdmfFile << "      </Attribute>" << std::endl;
