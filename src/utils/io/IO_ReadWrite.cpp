...
#ifdef USE_MPI
    ppkMHD::io::Load_HDF5_mpi<TWO_D> reader(Udata, params, configMap, HYDRO_2D_NBVAR, variables_names);
...
#ifdef USE_MPI
    ppkMHD::io::Load_HDF5_mpi<THREE_D> reader(Udata, params, configMap, HYDRO_3D_NBVAR, variables_names);
    reader.load(inputFilename);
#else
    ppkMHD::io::Load_HDF5<THREE_D> reader(Udata, params, configMap, HYDRO_3D_NBVAR, variables_names);
    reader.load(inputFilename);
#endif // USE_MPI
