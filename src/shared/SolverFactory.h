...
private:
   ...
   */
  using SolverCreateFn = SolverBase * (*)(HydroParams & params, ConfigMap & configMap);
...
public:
   ...
   */
  void
  registerSolver(const std::string & key, SolverCreateFn cfn)
  {
   ...
   */
  SolverBase *
  create(const std::string & solver_name, HydroParams & params, ConfigMap & configMap)
  {
