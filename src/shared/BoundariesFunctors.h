...
public:
  MakeBoundariesFunctor2D(HydroParams params, DataArray2d Udata)
    : params(params)
    , Udata(Udata){};
...
public:
  MakeBoundariesFunctor3D(HydroParams params, DataArray3d Udata)
    : params(params)
    , Udata(Udata){};
...
public:
  MakeBoundariesFunctor2D_MHD(HydroParams params, DataArray2d Udata)
    : params(params)
    , Udata(Udata){};
...
public:
  MakeBoundariesFunctor3D_MHD(HydroParams params, DataArray3d Udata)
    : params(params)
    , Udata(Udata){};
