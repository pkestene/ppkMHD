...
public:
  ...
  virtual void
  make_boundary(DataArray2d Udata, FaceIdType faceId, bool mhd_enabled);
  virtual void
  make_boundary(DataArray3d Udata, FaceIdType faceId, bool mhd_enabled);

  virtual void
  make_boundaries_serial(DataArray2d Udata, bool mhd_enabled);
  virtual void
  ...
  virtual void
  make_boundaries_mpi(DataArray3d Udata, bool mhd_enabled);

  void
  copy_boundaries(DataArray2d Udata, Direction dir);
  void
  copy_boundaries(DataArray3d Udata, Direction dir);

  void
  transfert_boundaries_2d(Direction dir);
  void
  transfert_boundaries_3d(Direction dir);

  void
  copy_boundaries_back(DataArray2d Udata, BoundaryLocation loc);
  void
