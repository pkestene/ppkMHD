...
// c = a + b * s
void
vmadd(const Vector & a, const Vector & b, double s, Vector & c)
{
...
// !!! m is allocated here !!!
void
compute_householder_factor(Matrix & mat, const Vector & v)
{
...
void
Matrix::extract_column(Vector & v, int c)
{
  if (m != v.size)
  {
...
void
householder(Matrix & mat, Matrix & R, Matrix & Q)
{
