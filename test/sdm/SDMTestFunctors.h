...
public:
  ...
  InitTestFunctor(HydroParams params, SDM_Geometry<dim, N> sdm_geom, DataArray Udata)
  ...
  real_t
  f0(real_t x, real_t y, real_t z) const
  {
    UNUSED(z);
    return x + y + z;
  }
  ...
  KOKKOS_INLINE_FUNCTION
  real_t
  f1(real_t x, real_t y, real_t z) const
  {
    UNUSED(z);
    return x * x;
  }
  ...
  KOKKOS_INLINE_FUNCTION
  real_t
  f2(real_t x, real_t y, real_t z) const
  {
    UNUSED(z);
  ...
  KOKKOS_INLINE_FUNCTION
  real_t
  f3(real_t x, real_t y, real_t z) const
  {
    UNUSED(z);
  ...
  KOKKOS_INLINE_FUNCTION
  real_t
  f4(real_t x, real_t y, real_t z) const
  {
    UNUSED(z);
