 ...
 */
real_t
test_function_3d(real_t x, real_t y, real_t z)
{
...
public:
  ...
  real_t
  test_function_3d_(real_t x, real_t y, real_t z) const
  {
    ...
    for (int ii = 0; ii < stencil_size; ++ii)
    {
      ...
      { // avoid stencil center
        ...
        printf("[DEVICE] [% d,% d,% d,% d] % 7.5f\n",
               ...
               z,
               s,
               rhs[s] + this->test_function_3d_(0, 0, 0));
#endif
        s++;
      }
...
main(int argc, char * argv[])
{
  ...
  for (int ii = 0; ii < stencil_size; ++ii)
  {
    ...
    printf("polynomial eval on host [% d, % d,% d]  % 7.5f == % 7.5f\n",
           ...
           y,
           z,
           polynomial_eval<ncoefs>(
             eval_point[0], eval_point[1], eval_point[2], monomialMap.data_h, coefs),
